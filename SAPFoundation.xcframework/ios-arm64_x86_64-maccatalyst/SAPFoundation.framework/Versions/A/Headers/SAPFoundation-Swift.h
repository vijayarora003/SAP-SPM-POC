...
SWIFT_CLASS("_TtC13SAPFoundation22DefaultSAPWKUIDelegate") SWIFT_DEPRECATED_MSG("Please use your own UI delegate implementation")
@interface DefaultSAPWKUIDelegate : NSObject <WKUIDelegate>
...
/// Used internally to capture URLSessionDataTask calls for streaming network operations and delegate forwarding
SWIFT_CLASS("_TtC13SAPFoundation31SAPURLSessionDelegateDispatcher")
@interface SAPURLSessionDelegateDispatcher : NSObject <NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SAPURLSessionDelegateDispatcher (SWIFT_EXTENSION(SAPFoundation))
...
/// This class follows the Singleton pattern, ensuring a single global instance.
/// To store a custom event, access the API like this
/// Example Usage:
/// \code
...
///   </li>
/// </ul>
SWIFT_CLASS_NAMED("TelemetryService")
@interface SAPBTPSDKTelemetryService : NSObject
/// Static constant property that provides access to the TelemetryService singleton class.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SAPBTPSDKTelemetryService * _Nonnull shared;)
+ (SAPBTPSDKTelemetryService * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)initialization;
...
SWIFT_CLASS("_TtC13SAPFoundation27WKNavigationDelegateAdapter")
...
SWIFT_CLASS("_TtC13SAPFoundation25WKNavigationDelegateProxy")
...
/// A class for proxying a WKWebView’s WKUIDelegate.
/// Use this if you want to set your WKUIDelegate but also want to preserve the WKWebView’s original WKUIDelegate.
/// Usage example:
/// \code
/// let webView: WKWebView = ...
/// webView.uiDelegate = ... // original delegate
///
/// let uiDelegate: WKUIDelegate
/// let userDelegate: SAPWKUIDelegate
///
/// let proxy = WKUIDelegateProxy(webView: webView, proxyDelegate: uiDelegate, userDelegate: userDelegate)
///
/// \endcodeFrom now on, when the system calls on the WKUIDelegate methods, the proxy will be called.
SWIFT_CLASS("_TtC13SAPFoundation17WKUIDelegateProxy")
@interface WKUIDelegateProxy : NSObject <WKUIDelegate>
- (WKWebView * _Nullable)webView:(WKWebView * _Nonnull)webView createWebViewWithConfiguration:(WKWebViewConfiguration * _Nonnull)configuration forNavigationAction:(WKNavigationAction * _Nonnull)navigationAction windowFeatures:(WKWindowFeatures * _Nonnull)windowFeatures SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13SAPFoundation23WKWebViewViewController")
...
SWIFT_CLASS("_TtC13SAPFoundation27WebViewNavigationController")
@interface WebViewNavigationController : UINavigationController
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
- (nonnull instancetype)initWithNavigationBarClass:(Class _Nullable)navigationBarClass toolbarClass:(Class _Nullable)toolbarClass OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(maccatalyst,introduced=13.1) SWIFT_AVAILABILITY(ios,introduced=5.0);
