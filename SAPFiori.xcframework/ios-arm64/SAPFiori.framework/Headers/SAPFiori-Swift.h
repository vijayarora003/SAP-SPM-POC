...
/// headline Label with the title and a <code>detailLabel</code> with instructions on how to start the
...
@interface FUIActivationScreen : FUIWelcomeController <UIScrollViewDelegate, UITextFieldDelegate>
...
@interface FUIActivationScreen (SWIFT_EXTENSION(SAPFiori))
...
@interface FUIAttachmentsFormCell : FUIInlineValidationTableViewCell
/// :nodoc:
@property (nonatomic, readonly) CGSize intrinsicContentSize;
/// :nodoc:
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
...
/// <code>FUIBarButtonItem</code> also provides a few convenience <code>init()</code>s to return a newly initialized SAPFiori Style <code>UIBarButtonItem</code>. It has the SAPFiori styles, font & color for title and icon, <code>.quaternaryFill</code> background color for  <code>.highlighted</code> state, and a minimum 44x44 touch area.
...
/// Initializes a new SAPFiori Style <code>UIBarButtonItem</code> using the specified custom view.
...
///
/// returns:
/// A newly initialized SAPFiori Style <code>UIBarButtonItem</code> with the specified custom view.
- (nonnull instancetype)initWithCustomView:(UIView * _Nonnull)customView;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The <code>delegate</code> property of the <code>FUIBarcodeScanViewController</code> and the properties of the <code>FUIBarcodeScanner</code> may be set in the prepare for
...
/// The FUIBaseCalendarItemCollectionViewCell class defines the attributes and
/// behavior of the cells that appear in calendar view objects.
SWIFT_CLASS("_TtC8SAPFiori37FUIBaseCalendarItemCollectionViewCell")
@interface FUIBaseCalendarItemCollectionViewCell : UICollectionViewCell
...
@interface FUIBasicAuthenticationScreen : FUIWelcomeController <UIScrollViewDelegate>
...
@interface FUIBasicAuthenticationScreen (SWIFT_EXTENSION(SAPFiori))
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
@end
...
/// Init button with expected style (for default, use <code>.tertiary</code>).
/// <blockquote>
/// To use <code>FUIButton</code> style variants in Interface Builder, the convenience subclasses <code>FUIRoundedButton</code> (<code>.tertiary</code>) and <code>FUIRoundedFillButton</code> (<code>.primary</code>) are also available.
///
/// </blockquote>
/// \code
...
///
/// \endcode<h2>Setting button style and semantic attribute</h2>
...
///
/// \endcodeIn any style, you may choose to override the title color for state, which is useful for applying an inverted style.
/// \code
/// button.setTitleColor(UIColor.preferredFioriColor(forStyle: .header), for: .normal)
///
/// \endcodeYou can set whether the border color is applied based on<code>UIControlState</code>
/// \code
...
/// Button {}
/// fdlFUIButton {}
/// Supported <code>Button</code> attributes:
/// tint-color { -selected | -highlighted | -selected-highlighted | -selected-disabled | -disabled } (Color)
/// background-color { -normal | -selected | -highlighted | -selected-highlighted | -selected-disabled | -disabled }  { -primary| -secondary| -tertiary } (Color)
...
/// Overriding BCP1770437033 for 1870099369, FUIButtonFormCell does not support Dynamic Type
/// /// :nodoc:
/// open override func systemLayoutSizeFitting(_ targetSize: CGSize, withHorizontalFittingPriority horizontalFittingPriority: UILayoutPriority, verticalFittingPriority: UILayoutPriority) -> CGSize {
/// // BCP 1770437033: Set height to 44
/// return CGSize(width: targetSize.width, height: 44)
/// }
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)prepareForReuse;
...
/// Base inner view for <code>FUIButtonCollectionViewCell</code>.
SWIFT_CLASS("_TtC8SAPFiori17FUIButtonFormView")
@interface FUIButtonFormView : FUIBaseDrawingView
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// This protocol defines the functions to be invoked when user taps the <em>Done</em> button on the <code>FUICalendarFloorplanViewController</code>.
...
/// The <code>FUICalendar</code> style to be displayed can be specified in the controller <code>init</code> method. All calendar styles are supported except expandable. In the case of <code>rangeSelectionView</code> and <code>datesSelectionView</code>, no table view is displayed and the <code>calendarView</code> occupies the full screen. In the case of month or week styles, if the <code>allowsStyleSwitching</code> flag is enabled, clicking the right bar button in the navigation bar allows the calendar to switch between month and week styles.
/// <img src="../ReadmeImages/FUICalendarFloorplan-Month.png?raw=true" alt="Calendar View"/>
/// <img src="../ReadmeImages/FUICalendarFloorplan-Week.png?raw=true" alt="Calendar View"/>
...
/// <code>FUICalendarView</code> control extends <code>UIView</code> and provides APIs to add calendar functionality in your app with minimal effort. There are five variations of <code>FUICalendarView</code>, as specified by the <code>FUICalendarStyle</code> enum-based data display and selection options.
/// <h3>Month</h3>
/// <img src="../ReadmeImages/FUICalendar-MonthView.png?raw=true" alt="Calendar View"/>
...
/// If the month contains today’s date, then the current date shows selected instead. When the user clicks on another date, then that date appears selected. When <code>isPersistentSelection</code> is set to true, the selection behavior is different from the default selection behavior, where no date appears selected when the calendar is initially displayed (unless the developer has set a selected date using the <code>selectDate</code>: API). When the user selects a date, that date stays selected regardless of scrolling to another month. In both the <code>isPersistentSelection</code> and default mode, the developer can force a date to be selected at calendar startup by calling the <code>selectDate</code>: API for month, week, expandable and <code>datesSelection</code> styles) or <code>selectDateRange</code>: API for <code>rangeSelection</code> style.
/// <h3>Week</h3>
/// <img src="../ReadmeImages/FUICalendar-WeekView.png?raw=true" alt="Calendar View"/>
...
/// If <code>isPersistentSelection</code> is set to true, then when the user selects a date, that date stays selected regardless of scrolling. In both the <code>isPersistentSelection</code> and default mode, the developer can force a date to be selected at calendar startup or after a scroll by calling the <code>selectDate</code>: or <code>selectDateRange</code>: API , after calendar init or from within the <code>calendarView(_:didChangeVisibleDatesTo:)</code> delegate.
/// <h3>Expandable</h3>
/// <img src="../ReadmeImages/FUICalendar-ExpandableView1.png?raw=true" alt="Calendar View"/>
/// <img src="../ReadmeImages/FUICalendarExpandableView2.png?raw=true" alt="Calendar View"/>
...
/// <h3><code>rangeSelection</code></h3>
/// <img src="../ReadmeImages/FUICalendar-MultipleSelectionView.png?raw=true" alt="Calendar View"/>
/// This view displays the dates similar to the month style, but takes the entire screen space. Therefore, dates for more than one month can be displayed at a time. Also, this view allows the user to select a contiguous range of dates. <code>isPersistentSelection</code> is always set to true and the selected <code>dateRange</code> stays selected regardless of scrolling to another month. The first date selected is the <code>startDate</code> of the range and when a second date is selected it becomes the end date of the range, with the entire range of dates between the start and end dates (inclusive) being selected. To modify the set of selected dates, click on a selected date within the range and it becomes the new end date with all the dates later than that getting deselected. To unselect the entire range, click outside the range, anywhere in the calendar view. The end range of the range must be a later date than the start date. If the user clicks on a date earlier than the start date, then the newly selected date now becomes the start date and the original start date is deselected.
/// <h3><code>datesSelection</code></h3>
/// <img src="../ReadmeImages/FUICalendar-datesSelectionView.png?raw=true" alt="Calendar View"/>
/// Similar to <code>rangeSelection</code>, this style takes the entire screen space. However, it differs from the <code>rangeSelection</code> in how the dates are selected, allowing for the selection of multiple noncontiguous dates. It also provides a <code>swipeToSelect</code> functionality, where swiping across the screen would select or deselect the corresponding dates at that location.
/// The <code>FUICalendar</code> can be instantiated to display in any one of the above display modes. In addition, the developer can specify the start and end dates of the entire calendar range and the <code>displayDateAtStartup</code> at startup. If the start, end, and display dates are nil, that is, the user does not supply any values for those parameters, then the calendar is instantiated with a two-year range from Jan 1st of the current year to Dec 31st of the next year and the display date on startup is set to the current date.
/// The user can also choose to provide only the start date, end date, or display date. If the start and end dates are provided, then set up the range accordingly. If no display date is provided in this case, and if the current date falls in-between this provided range, then the calendar shows the current date on startup, otherwise the start date is displayed on startup. If only the display date is provided, then the range is from Jan 1st of the year of the <code>displayDate</code> to Dec 31st of next year.
/// <h2>Theming</h2>
/// <h3><code>FUICalendarView</code> Theming</h3>
/// \code
...
/// font-name: FontName;
///
/// \endcode<h3><code>FUICalendarItemView</code> Theming</h3>
/// \code
...
///
/// \endcode<h3><code>FUIWeekLabelView</code> Theming</h3>
/// \code
...
/// <img src="../ReadmeImages/ContactCellAnnotations.png?raw=true" alt="Contact Cell"/>
/// <h2>Code usage:</h2>
/// \code
///
...
/// Image of <code>ContactCell</code>.
@property (nonatomic, strong) IBInspectable UIImage * _Nullable detailImage;
/// Text of <code>tags</code> for IB display purposes only
...
@interface FUIContactCell (SWIFT_EXTENSION(SAPFiori))
/// :nodoc:
...
/// A <code>FUIDataTable</code> is a view that displaying data in either a list view or a grid table view.
/// <h2>Code usage:</h2>
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori12FUIDataTable")
@interface FUIDataTable : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
/// The ideal size for the <code>FUIDataTable</code>, considering only properties of the view itself.
/// Changing preferredMaxLayoutWidth can cause the change of intrinsicContentSize.
@property (nonatomic, readonly) CGSize intrinsicContentSize;
/// Asks the <code>FUIDataTable</code> to calculate and return the size that best fits all rows & columns by giving a size.width (the passed size.height is ignored).
/// Invoking this method won’t change the intrinsicContentSize.
...
/// Returns the optimal size of the <code>FUIDataTable</code> based on its constraints and the specified fitting priorities.
/// Invoking this method can cause the change of intrinsicContentSize.
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
/// A FUIDimensionSelector object is a horizontal control made up of multiple segments, each segment functioning as a discrete button.
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori20FUIDimensionSelector")
@interface FUIDimensionSelector : UIView
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, readonly, weak) IBOutlet UILabel * _Null_unspecified valueLabel;
/// The <code>UIPickerView</code> for this cell.
/// This <code>durationPicker</code> will be displayed only when this cell is selected.
@property (nonatomic, readonly, strong) UIPickerView * _Nonnull durationPicker;
/// :nodoc:
- (void)prepareForInterfaceBuilder;
...
@interface FUIDurationPickerFormCell (SWIFT_EXTENSION(SAPFiori)) <UIPickerViewDataSource>
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end


@interface FUIDurationPickerFormCell (SWIFT_EXTENSION(SAPFiori)) <UIPickerViewDelegate>
...
@interface FUIDynamicAuthenticationScreen : FUIWelcomeController <UIScrollViewDelegate>
/// The detail message label to display the message of this screen.
/// The default text of this label is
...
@interface FUIDynamicAuthenticationScreen (SWIFT_EXTENSION(SAPFiori))
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
@end
...
@interface FUIEULAViewController : FUIWelcomeController <UIScrollViewDelegate>
...
/// <code> FUIEmptyStateView:</code> conforms to the <code>UIView</code> class and contains SwiftUI component <code>EmptyStateView</code> as a container.
/// Usage 1: simple
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori17FUIEmptyStateView")
@interface FUIEmptyStateView : FUIBaseDrawingView
...
/// <img src="../ReadmeImages/FUIFeedbackScreenAnnotations.png?raw=true" alt="Feedback Screen"/>
...
@interface FUIFeedbackScreen (SWIFT_EXTENSION(SAPFiori))
@end
...
/// }
///
/// \endcodeTo keep selected item in the original order, use following code:
/// \code
/// filterFeedbackControl.keepsItemOrderOnSelection = true
///
/// \endcodeImplement the <code>FUIFilterFeedbackControlDelegate</code> to set cell properties such as accessibility:
/// \code
...
SWIFT_CLASS("_TtC8SAPFiori18FUIFilterValueView")
@interface FUIFilterValueView : UIControl <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init;
/// :nodoc:
- (void)layoutSubviews;
...
/// When <code>FUIListPickerCollectionViewCell</code>s are to be used in an application, the application’s implementation of
/// <code>UICollectionViewController</code> that hosts these <code>FUIListPickerCollectionViewCell</code>s must be a subclass of this
/// <code>FUIFormCollectionViewController</code>. <code>FUIFormCollectionViewController</code> hides all the complexity
/// and interactions for handling <code>FUIListPickerCollectionViewCell</code>.
/// The application’s implementation of the <code>UICollectionViewController</code> needs to only
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori31FUIFormCollectionViewController")
@interface FUIFormCollectionViewController : UICollectionViewController
/// :nodoc:
- (nonnull instancetype)init;
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
/// The <code>contentMode</code> of the <code>FUIImageView</code> is set the <code>scaleAspectFit</code> by default
/// remark:
///
...
/// }
///
/// \endcode<h2>Override <code>tableView(_: viewForHeaderInSection:)</code> <code>dataSource</code> method and configure header.</h2>
/// \code
/// // header data list
/// var headerData: [FUIGridRowItem] {
/// let item0 = FUIGridRowHeaderItem(text: " ")
...
///
/// \endcodeImplement <code>dataSource</code> methods.
/// \code
...
/// }
///
/// \endcodeImplement <code>dataSource</code> and delegate methods
/// \code
///
/// // Define your data model.
/// var model = HierarchyViewModel()
...
@interface FUIHorizontalScrollCollectionViewLayout : UICollectionViewLayout
/// :nodoc:
@property (nonatomic, readonly) BOOL flipsHorizontallyInOppositeLayoutDirection;
/// :nodoc:
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) Class _Nonnull invalidationContextClass;)
...
/// The content view of a <code>FUIInlineSignatureFormCell</code>.
/// <h2>Theming</h2>
/// Supported <code>FUIInlineSignatureFormView</code> class path:
/// \code
/// fdlFUIInlineSignatureFormView
///
/// \endcodeSupported <code>FUIInlineSignatureFormView</code> properties:
/// \code
/// stroke-width: (Number)
/// stroke-color: (Color)
...
///
/// \endcodeSupported <code>Text</code> class path:
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori26FUIInlineSignatureFormView")
@interface FUIInlineSignatureFormView : FUIBaseDrawingView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
...
SWIFT_CLASS("_TtC8SAPFiori45FUIInlineValidationUIControlTintTableViewCell")
@interface FUIInlineValidationUIControlTintTableViewCell : FUIInlineValidationTableViewCell
- (void)prepareForReuse;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// <code>FUIKPIHeader</code> extends <code>UIView</code> for a table view header displaying KPI items, of type <code>FUIKPIView</code> and <code>FUIKPIProgressView</code>. A maximum of four KPI values can be displayed in the header, hence if more than four items are provided in the items array as input to the header, only the first four are displayed and the rest of the items are ignored. When both <code>FUIKPIView</code> and <code>FUIKPIProgressView</code> items are provided, the items are sorted such that the <code>FUIKPIProgressViews</code> are displayed first, followed by the <code>FUIKPIViews</code>. Only <code>FUIKPIProgessViews</code> with <code>chartSize</code> of ‘large’can be displayed in the header , if an <code>FUIProgressView</code> of <code>charSize</code>  ‘small’is supplied, it is ignored. Based on the number of KPI items that can be shown based on the screen size, a page control is used to display multiple pages in the header, as required. The KPI items in the header can be enabled or disabled. The default KPI header background is of color scheme <code>.dark</code>, hence to display the KPI items with the appropriate <code>tintColor</code> as per the Fiori design guidelines for iOS, it is required that the KPI items supplied to the header have a color scheme of <code>.dark</code> as well. The developer can choose to supply a custom tint color for the KPIs. It is important to set the <code>colorScheme</code> of the KPI before the call to override the <code>tintColor</code>, as shown below.( since setting the <code>colorScheme</code> resets the <code>tintColor</code> to the defaults, if the calls are not in order, then the custom <code>tintColors</code> are not displayed.)
/// \code
///
...
/// <img src="../ReadmeImages/KPIHeader-RegularMode.png?raw=true" alt="KPI Header"/>
/// <h2>Compact (Portrait) Horizontal Size Class: Variations</h2>
/// <img src="../ReadmeImages/KPIHeader-CompactMode.png?raw=true" alt="KPI Header"/>
/// <h2>Example Initialization and Configuration:</h2>
...
///
/// \endcode<h2>Note:</h2>
/// <code>FUIKPIHeader</code> added to <code>UITableView</code> as <code>tableHeaderView</code> is compatible with <code>UIRefreshControl</code> added to the same table view.  Please note that if an <code>UIRefreshControl</code> object is set after adding an <code>FUIKPIHeader</code> object as <code>tableHeaderView</code>, the <code>UIRefreshControl</code> subview must be moved to the front in the <code>tableView</code>; otherwise, the <code>UIRefreshControl</code> object will be hidden.
/// \code
///
...
/// <ul>
///   <li>
///     <code>chartSize</code>: <code>KPICharts</code> can be small (104 px circle) or large (130 px circle).  Large is default
///   </li>
///   <li>
...
///   </li>
///   <li>
///     <code>captionLabel</code>: An optional label displayed directly beneath the KPI components.  The label will shift to underneath the circle if sizing requires. For small charts, the caption can be up to 86 px in length.  Greater than that, it moves outside of the circle and can wrap to up to 2 lines of 122 px per line.  For large charts, the caption inside the circle can be up to 94 px.  Beyond that, it moves outside the circle and wraps to up to 2 lines of 216 px per line.
///   </li>
/// </ul>
...
/// <ul>
///   <li>
///     Call <code>setTintColor(_:for:)</code> to configure tint color for disabled, normal, highlighted <code>UIControlState</code>. Setting <code>tintColor</code> is equivalent to call <code>setTintColor(color, for: UIControlState.normal)</code>. If <code>tintColor</code> is not set by developer, <code>colorScheme</code> will be applied.
///   </li>
///   <li>
///     Call <code>setTextColor(_:for:)</code> to configure tint color for disabled, normal, highlighted <code>UIControlState</code> of the <code>KPIView</code> and caption text.
///   </li>
///   <li>
///     Disabled: Color to be used when control is disabled.
///   </li>
...
///
/// \endcode<h3>Inside a Storyboard or <code>xib</code>:</h3>
/// <ol>
///   <li>
///     Drag and drop a <code>UIView</code> component to Interface Builder’s canvas.
///   </li>
...
/// <ul>
///   <li>
///     <code>metric</code>:  the value which is being displayed.  For example, in: <code>$256k</code>, the metric is “256”.
///   </li>
///   <li>
///     <code>unit</code>: the unit information for the metric displayed.  For example, in <code>$256k</code>, the units are “$” and “k”.  Multiple unit components are permitted per metric.  However, a maximum of two units should be used on each side of the metric.
///   </li>
///   <li>
///     <code>icon</code>:  a <code>32px x 32px</code> icon may be displayed.  Icons should only be displayed to the <em>left</em> of a metric.  Units may still be displayed to the right of the metric, when an icon is displayed.
///   </li>
///   <li>
...
SWIFT_CLASS("_TtC8SAPFiori12FUILabelItem")
@interface FUILabelItem : FUIDrawingView
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic) BOOL showsSelectedSectionOnUIDDataSourceSearch;
...
/// For “Unique Identifier” type data sources, if this optional function is implemented,
/// and returns a non-nil value, the “Select All” button will be shown.
/// Otherwise, the “Select All” button will not be shown.
/// This function has no effect on non-“Unique Identifier” type data sources.
- (NSArray<NSString *> * _Nullable)allUniqueIdentifiersIn:(id <FUIListPicker> _Nonnull)listPicker SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)allUniqueIdentifierIn:(id <FUIListPicker> _Nonnull)listPicker SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'allUniqueIdentifier' has been renamed to 'allUniqueIdentifiersIn:'");
@end
...
/// Base inner view to display a key-value pair property for <code>FUIListPickerCollectionViewCell</code>.
/// Please refer to the <code>FUIListPickerCollectionViewCell</code> documentation for details.
SWIFT_CLASS("_TtC8SAPFiori21FUIListPickerFormView")
@interface FUIListPickerFormView : FUIDrawingView
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// The section header view for the <code>FUIListPickerTableViewController</code>.
/// <h2>Theming</h2>
/// Supported style classes
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori23FUIListPickerHeaderView")
@interface FUIListPickerHeaderView : UITableViewHeaderFooterView
/// The <code>UILabel</code> for the title.
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
/// The <code>FUIButton</code> for the action button.
@property (nonatomic, weak) IBOutlet FUIButton * _Null_unspecified actionButton;
...
@property (nonatomic, strong) IBOutlet UIBarButtonItem * _Null_unspecified cancelBarButtonItem;
/// :nodoc:
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
@interface FUIListPickerTableViewController (SWIFT_EXTENSION(SAPFiori)) <UISheetPresentationControllerDelegate>
/// :nodoc:
...
/// <h2>iPad</h2>
/// The view is placed in the top left corner of the iPad and will dynamically resize based on the <code>preferredContentSize</code>.  The view is pinned to the given <code>pinMapView</code> and will resize accordingly.  The <code>fitToContent</code> method must be called when reloading the table view.
/// <h2>Available:</h2>
/// <ul>
///   <li>
...
///   </li>
///   <li>
///     <code>searchResults</code>: A <code>FUIMapDetailPanelSearchResultsViewController</code> used for the search function.  Manipulate its <code>tableView</code> to show search results.  The developer must set the <code>datasource</code> and delegate methods.
///   </li>
///   <li>
///     <code>content</code>: A <code>FUIMapDetailPanelContentViewController</code> used for showing the details.  The developer must set the <code>datasource</code> and delegate methods.
///   </li>
/// </ul>
/// <h2>Usage</h2>
/// \code
...
///
/// \endcodePresent the <code>detailPanel</code> by managing selecting and deselecting map annotations in <code>mapView(_:didSelect:)</code> and <code>mapView(_:didDeselect:)</code>
/// \code
...
/// Fiori style <code>UISearchBar</code>.
...
/// <code>FUIMapLegend</code> extends <code>UIViewController</code> to show the Map Legend.
...
/// <h2>Available in <code>FUIMapLegend</code>:</h2>
/// <ul>
///   <li>
...
///   </li>
///   <li>
///     Enter <code>FUIModalCheckout</code> as Storyboard and the bundle for SAPFiori framework as Bundle.
///   </li>
///   <li>
...
/// <code>FUIModalProcessingIndicatorView</code> shows a <code>FUIProcessingIndicatorView</code> centered in a container area of the screen and disables interaction. The container can be either a view or a window. An overlay is shown behind the processing indicator, which covers the whole container. The overlay can be either set to translucent <code>white</code> or to be using a <code>UIVisualEffectView</code> to achieve a blurred background.
/// By default, the processing indicator is shown centered on screen and shows a translucent <code>white</code> overlay. The view is not visible and the animation is stopped until <code>show()</code> is called.
...
/// And <code>AppDelegate</code> needs to lock the screen orientation when these screens are shown, similar to the following code snippet.
/// In app’s <code>AppDelegate</code>:
/// \code
///
...
/// variables in this <code>FUIPasscodeController</code> class at runtime.
/// <h2>Theming</h2>
/// Supported style classes
/// \code
...
@interface FUIPasscodeController : UIViewController <UIScrollViewDelegate>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
...
SWIFT_CLASS("_TtC8SAPFiori23FUINavigationController") SWIFT_DEPRECATED_MSG("No longer supported. Please use UINavigationController.")
@interface FUINavigationController : UINavigationController
- (nonnull instancetype)initWithNavigationBarClass:(Class _Nullable)navigationBarClass toolbarClass:(Class _Nullable)toolbarClass OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=5.0,message="No longer supported. Please use UINavigationController.") SWIFT_DEPRECATED_MSG("No longer supported. Please use UINavigationController.");
...
/// <h2>Views Available in <code>FUIObjectCell</code>:</h2>
/// <ul>
///   <li>
...
///   </li>
///   <li>
///     <code>subheadlineLabel</code>: a <code>UILabel</code> view is added <code>3px</code> below <code>headlineLabel</code> to the cell. Use `cell.subheadlineText” to set label text.
///   </li>
///   <li>
///     <code>footnoteLabel</code>: a <code>UILabel</code> view is added <code>3px</code> below <code>subheadLabel</code> to the cell. Use <code>cell.footnoteText</code> to set label text.
///   </li>
///   <li>
...
/// <h2>Usage</h2>
/// Usually, the creation of <code>FUIOfflineBannerMessageView</code> and attachment to <code>FUINavigationBar</code> is
...
///   </li>
///   <li>
///     Check image: a green circle with <code>white</code> check mark in the middle
///   </li>
///   <li>
...
/// <ul>
///   <li>
///     <code>passcodeControllerDelegate</code>: An implementation of <code>FUIPasscodeControllerDelegate</code> that handles events from this controller for both <code>FUIPasscodeInputController</code> and <code>FUIPasscodeCreateController</code>.
///   </li>
///   <li>
///     <code>validationDelegate</code>: An implementation of <code>FUIPasscodeValidationDelegate</code> that validates the passcode entered by the user.
///   </li>
/// </ul>
...
///     authenticate with Touch ID. Once user enters fingerprint or device passcode, the stored passcode in the keychain is retrieved and the delegate’s <code>shouldTryPasscode</code> is invoked to validate the old passcode. And a new passcode is generated and <code>shouldTryPasscode</code> is invoked again to validate the new passcode. The new passcode is then saved in the keychain without other user actions.
///   </li>
///   <li>
...
/// <ul>
///   <li>
///     Use another story board and using a “Present Modally” segue to <code>FUIPasscodeCreateController</code> storyboard in <code>SAPFiori</code>’s framework bundle.
///     App programmer needs to provide the properties needed in <code>UIController</code>’s prepare for segue function:
///   </li>
/// </ul>
/// \code
...
@interface FUIPasscodeCreateController (SWIFT_EXTENSION(SAPFiori))
/// :nodoc:
...
/// This <code>UITableViewController</code> is used to display the edit operation of the permission.
/// Example:
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori43FUIPrivacyNoticeDetailSettingViewController")
@interface FUIPrivacyNoticeDetailSettingViewController : UITableViewController
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
/// This <code>UITableViewController</code> is used to display a perissions screen to the application for settings. The screen mainly show the privacy authorization status of the application.
/// \code
...
///
/// \endcodeTheming:
/// Support <code>TableViewCell</code> class paths:
/// \code
/// fdlFUIPrivacyNoticeSettingsCell {}
///
/// \endcodeSupported <code>TableViewCell</code> attributes:
/// \code
/// tint-color (Color)
/// background-color (Color)
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori43FUIPrivacyNoticeSettingsTableViewController")
@interface FUIPrivacyNoticeSettingsTableViewController : UITableViewController
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
/// View component of an <code>FUIPrivacyNoticeController</code>.
/// Example:
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori20FUIPrivacyNoticeView")
@interface FUIPrivacyNoticeView : FUIDrawingView
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
///   </li>
/// </ul>
/// <h2>Views Available in <code>FUIProfileHeader</code>:</h2>
/// <ul>
///   <li>
...
/// Developer may choose to dismiss the message view when user navigates to other views by calling the <code>dismissBanner</code> function of the <code>FUIProgressBannerMessageView</code>.
...
/// <h2>Usage</h2>
/// Usually, the creation of <code>FUIProgressBannerMessageView</code> and attachment to <code>FUINavigationBar</code> is
/// in the <code>viewDidAppear</code> function of a <code>UIViewController</code>. As the code indicates below:
/// \code
...
///   </li>
///   <li>
///     Control-drag from the progress indicator control in Interface Builder to your source file to create an outlet of the <code>FUIProgressIndicatorControl</code> and to be able to access its properties.
///   </li>
///   <li>
///     Control-drag from the progress indicator control in Interface Builder to your source file and create an action for the <code>FUIProgressIndicatorControl</code>. Make sure to select <code>TouchUpInside</code> as event type. Specify an action name and implement the generated callback method to react accordingly once the user tapped the control.
///   </li>
/// </ol>
/// <h2>Usage</h2>
/// \code
...
SWIFT_CLASS("_TtC8SAPFiori14FUIRangeSlider")
@interface FUIRangeSlider : UIControl
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
...
@interface FUIRangeSlider (SWIFT_EXTENSION(SAPFiori))
/// :nodoc:
...
/// Convenience subclass of <code>FUIButton</code> implementing <code>FUIButtonStyle.secondary</code> ( previous<code>FUIButtonStyle.fuiRounded</code> in 7.0 release ), for use in Interface Builder.
...
/// Convenience subclass of <code>FUIButton</code> implementing <code>FUIButtonStyle.primary</code> ( previous <code>FUIButtonStyle.fuiRoundedFilled</code> in 7.0 release), for use in Interface Builder.
...
/// Fiori style <code>UISearchController</code>. The only difference between <code>FUISearchController</code>
...
/// </ul>
/// <h2>Usage</h2>
/// Subclassing and conforms to delegate. It conforms to <code>UITableViewDataSource</code> and <code>UITableViewDelegate</code> by default.
/// \code
...
/// A <code>UISegmentedControl</code> subclass with Fiori styles.
/// <h2>Usage:</h2>
/// \code
...
///
/// \endcode<h3>Use segment control in a container with dark background</h3>
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori17FUISegmentControl")
@interface FUISegmentControl : UISegmentedControl
/// :nodoc:
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (void)setTitleTextAttributes:(NSDictionary<NSAttributedStringKey, id> * _Nullable)attributes forState:(UIControlState)state;
/// :nodoc:
- (void)layoutSubviews;
@end
...
/// A base <code>FUISegmentedControlFormView</code> that allows a user to view or select from a list of strings using a Fiori-styled segmented control.
/// The <code>value</code> property of the cell is equal to the <code>selectedSegmentIndex</code> in the segmented control.
/// Specify the height for segments by setting the <code>segmentHeight</code> API. By default it is set to nil, which means the segment will adjust its height to fit the content.
/// Color setting:
/// Setting the text color of buttons in the cell for a state using the <code>setButtonAttributes(_:for:)</code> API. The supported states are: <code>disabled</code>, <code>normal</code>, and <code>selected</code>.
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori27FUISegmentedControlFormView")
@interface FUISegmentedControlFormView : FUIBaseDrawingView
...
@interface FUISegmentedControlFormView (SWIFT_EXTENSION(SAPFiori)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
/// :nodoc:
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
/// The content view of a <code>SettingsCell</code>.
SWIFT_CLASS("_TtC8SAPFiori22FUISettingsContentView")
@interface FUISettingsContentView : FUIDrawingView
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize withHorizontalFittingPriority:(UILayoutPriority)horizontalFittingPriority verticalFittingPriority:(UILayoutPriority)verticalFittingPriority SWIFT_WARN_UNUSED_RESULT;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// The <code>FUISignatureCaptureView</code> for this <code>FUISignatureCaptureController</code>.
...
@property (nonatomic, readonly, strong) IBOutlet UIBarButtonItem * _Null_unspecified cancelButton;
...
@property (nonatomic, readonly, strong) IBOutlet UIBarButtonItem * _Null_unspecified doneButton;
...
@property (nonatomic, readonly, strong) IBOutlet UIBarButtonItem * _Null_unspecified clearButton;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
- (void)viewWillAppear:(BOOL)animated;
...
///
/// \endcodeDequeue a <code>FUISimplePropertyCollectionViewCell</code> object from a collection view’s <code>dataSource</code> method <code>collectionView(_:cellForItemAt:)</code>
/// \code
/// public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
...
/// This view appears as the <code>accessoryView</code> to the <code>FUIObjectTableViewCell</code>.
/// <h2>Available:</h2>
/// <ul>
///   <li>
///     <code>progressView</code>: A <code>FUISingleActionProgressIndicator</code> used to display progress.  Toggle between the states by changing the <code>actionAccessoryType</code>.
///   </li>
///   <li>
///     <code>button</code>: A <code>FUISingleActionButton</code> displayed in the <code>FUISingleActionAccessoryView</code>.  This button’s width will not exceed 45% of the width of the container.  Button height will dynamically resize based on button text.  Button text can wrap two lines.  Use the button’s <code>titleLabel</code> <code>preferredMaxLayoutWidth</code> and the button’s <code>isPreservingPreferredMaxLayoutWidth</code> to set the button’s width. <em>Note</em> Developer should change <code>preferredMaxLayoutWidth</code> depending on the accessibility text size.
///   </li>
///   <li>
...
/// <code>FUISortFilterViewController</code> allows users to narrow down results from a long list by setting criteria. Users are able to reset filters and return to the initial list.
/// Various <code>ControlType</code>s, such as switch, filter, rating, etc. are supported for sort and filter criteria.
/// <h2>Initialization and Configuration Example:</h2>
/// \code
...
///
/// \endcode<h2>Note:</h2>
/// The title and subtitle for <code>UINavigationBar</code> and title for the <em>Action</em> button in the bottom <code>UIToolbar</code> can be customized as well.
/// \code
...
/// }
///
/// \endcode<h2><code>FUISortFilterFormDelegate</code> Example:</h2>
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori27FUISortFilterViewController")
@interface FUISortFilterViewController : FUIFormTableViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)viewDidDisappear:(BOOL)animated;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
...
/// <code>FUITagView</code> is an enhanced <code>FUILabel</code> that applies Fiori Design tag color schemes to the label by default.
/// <h2>Usage</h2>
/// <ul>
///   <li>
///     Initializing programmatically:
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori10FUITagView")
@interface FUITagView : UIView
- (void)layoutSubviews;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
...
/// <img src="../ReadmeImages/TimelineCellAnnotation.png?raw=true" alt="Timeline Cell"/>
/// <ul>
///   <li>
...
///
/// \endcode<h2>Notes</h2>
/// <h3><code>SingleLine</code> Separator Between Timeline Items in the Table</h3>
...
/// }
///
/// \endcode<h3>Customize the Background Color</h3>
...
@property (nonatomic, readonly, weak) IBOutlet FUILabel * _Null_unspecified secondaryTimestampLabel;
/// A separator line in the cell’s top.
/// The default is <code>separatorLineView.isHidden = false</code>.
/// Use <code>separatorLineView.isHidden = true</code> hide separator line.
@property (nonatomic, readonly, weak) IBOutlet UIView * _Null_unspecified separatorLineView;
...
/// <code>FUITimelineCollectionViewCell</code> is an Interface-Builder-designable UI component that extends <code>NibDesignableCollectionViewCell</code> for showing information of a task. <code>FUITimelinePreviewView</code> embeds a collection view which displays a set of <code>FUITimelineCollectionViewCell</code>.
/// <h2>Views Available in <code>FUITimelineCollectionViewCell</code>:</h2>
/// <ul>
///   <li>
///     <code>titleLabel</code>:  an <code>UILabel</code> showing a short description of the task.
///   </li>
///   <li>
///     <code>footnoteLabel</code>: an<code>UILabel</code> showing extra information about the task. When cell is used with a <code>FUITimelinePreviewView</code>, the textual representation of due date of <code>FUITimelineItem</code> is put here.
///   </li>
///   <li>
///     <code>nodeImageView</code>: an<code>UIImageView</code> contains a node image showing the status of the task. You change the node type by setting ‘nodeType’ on <code>FUITimelineCollectionViewCell</code>.
///   </li>
/// </ul>
/// <h2>Example Initialization and Configuration:</h2>
/// \code
...
/// <img src="../ReadmeImages/TimelineMarkerCellAnnotation.png?raw=true" alt="Timeline Marker Cell"/>
/// <ul>
///   <li>
...
/// \endcode<h2>Notes</h2>
/// <h3><code>SingleLine</code> Separator Between Timeline Items in the Table</h3>
/// The default table view <code>separatorStyle</code> is <code>.singleLine</code>.  Because of this default setting, there can be a 1.0 px divider line or a separator in-between each item on the timeline in the table.  This is not an issue in timeline.  To get rid of the separator, set <code>separatorStyle</code> to <code>none</code> in the <code>TabelViewController</code> class
/// \code
///
/// override func viewDidLoad() {
///    super.viewDidLoad()
...
/// <code>FUITimelineNowIndicatorCell</code> is a <code>UITableViewCell</code> subclass, designed to present now indicator in a Timeline view.
/// <h2>Usage</h2>
/// \code
///
/// override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
...
///
///
/// \endcode<h3>Hide the Separator in the next Timeline Items in the Table</h3>
/// The Separator can be hiden in the next Timeline cell as following
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori27FUITimelineNowIndicatorCell")
@interface FUITimelineNowIndicatorCell : NibDesignableFUIBaseTableViewCell
/// A node image view, centered on the cell’s vertical timeline line.
@property (nonatomic, readonly, strong) IBOutlet FUIImageView * _Null_unspecified nodeImageView;
@property (nonatomic, readonly, weak) IBOutlet UIView * _Null_unspecified indicatorLine;
/// The image used as node icon.
/// If the value of this property is not nil, the timeline cell uses the given image as the node icon. It ignores the value of the <code>nodeColor</code> property. The developer is responsible for providing a image with desired color.
@property (nonatomic, strong) IBInspectable UIImage * _Nullable nodeImage;
/// Property defining the timeline width, which is the width of the whole timestamp view left to the veritical line in the cell.  The default width is <code>70.0</code> px
@property (nonatomic) IBInspectable CGFloat timelineWidth;
/// :nodoc:
...
@interface FUITimelineNowIndicatorCell (SWIFT_EXTENSION(SAPFiori))
/// :nodoc:
- (void)traitCollectionDidChange:(UITraitCollection * _Nullable)previousTraitCollection;
@end
...
/// <code>FUITimelinePreviewTableViewCell</code> is an Interface-Builder-designable UI component that extends <code>NibDesignableTableViewCell</code> which contains a <code>FUITimelinePreviewView</code>. It resizes itself to fit content using the auto-layout size of <code>FUITimelinePreviewView</code>.
/// <h2>Views Available in <code>FUIObjectTableViewCell</code>:</h2>
/// <ul>
///   <li>
///     <code>timelinePreviewView</code>:  an <code>FUITimelinePreviewView</code> object contains a header and a collection view.
///   </li>
/// </ul>
/// <h2>Example Initialization and Configuration:</h2>
/// \code
...
/// <code>FUITimelinePreviewView</code> is an Interface-Builder-designable UI component that extends <code>UIView</code> for showing a collection of tasks. It comes with a header and a collection view which uses <code>FUITimelineCollectionViewCell</code> to represent data items within it.
/// Using <code>addItems()</code> to populate a collection of <code>FUITimelineItem</code> object.
/// <h2>Views Available in <code>FUIObjectCell</code>:</h2>
/// <ul>
///   <li>
///     <code>header</code>:  a <code>FUICollectionSectionHeaderFooterView</code> containing a title label, an attribute label and a disclosure indicator.
///   </li>
///   <li>
///     <code>collectionView</code>: a collection view displaying a collection of data items represented by <code>FUITimelineCollectionViewCell</code>.
///   </li>
/// </ul>
...
///
/// \endcode<h2>Theming</h2>
/// Supported <code>TableViewCell</code> class paths:
/// \code
/// fdlFUITitleFormCell {}
///
/// \endcodeSupported <code>TableViewCell</code> attributes:
...
///
/// \endcodeSupported <code>TextField</code> class paths:
/// \code
/// fdlFUITitleFormCell_valueTextField
///
/// \endcodeSupported <code>TextField</code> properties:
/// \code
/// font-color: Color;
/// font-color-disabled: Color;
...
@interface FUITitleFormCell : FUIInlineValidationUIControlTintTableViewCell <UITextFieldDelegate>
...
/// <code>FUIToolbar</code> is a subclass of ‘UIToolbar’ which displays the <code>UIBarButtonItem</code> array in Fiori style.
/// Developers needs to create <code>UINavigationController</code> with the following code to use <code>FUIToolbar</code> as its toolbar.
/// \code
/// UINavigationController(navigationBarClass: nil, toolbarClass: FUIToolbar.self)
///
/// \endcodeThen in the <code>viewDidLoad</code> function of the <code>UIViewController</code> use the following code to set the toolbar items for text buttons:
/// \code
/// var buttons: [FUIButton] = [...]
/// setFioriStyleToolbarItems(buttons, helperText: helperText, animated: true)
///
/// \endcodeOr, for icon type items:
/// \code
...
/// font-style: UIFontTextStyle;
///
/// \endcodeSupported <code>UIBarButtonItem</code> class path:
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori10FUIToolbar")
@interface FUIToolbar : UIToolbar
/// :nodoc:
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
/// that conform to the <code>FUIUserConsentForm</code> protocol, namely <code>FUISinglePageUserConsentForm</code> and
/// <code>FUIMultiPageUserConsentForm</code>. The Fiori for iOS SDK takes these forms and displays them modally as
/// single or multipage user consent screens using the <code>FUIUserConsentViewController</code>. A user consent screen
...
/// and <code>actionTitle</code> properties. For example, when both <code>title</code>and <code>titleAttributedText</code> are supplied, only
...
/// cancels the form. It is important that the <code>FUIUserConsentViewController</code>, passed in as the parameter
...
/// orientation, the app needs to switch to portrait mode before presenting the screen and the <code>AppDelegate</code>
...
/// text-align: NSTextAlignment;
///
/// \endcodeSupported <code>NavigationBar</code> class paths:
/// \code
...
/// <img src="../ReadmeImages/WelcomeScreenAnnotations.png?raw=true" alt="Welcome Screen"/>
/// <img src="../ReadmeImages/WelcomeScreenAnnotations_pt2.png?raw=true" alt="Welcome Screen"/>
...
///   </li>
///   <li>
///     <code>configurationOptions</code> property: <code>.discoveryService</code>
///   </li>
///   <li>
...
///   </li>
///   <li>
///     <code>configurationOptions</code> property: <code>.barcodeScanner</code>
///   </li>
///   <li>
...
///   </li>
///   <li>
///     <code>configurationOptions</code> property: [<code>.discoveryService, .barcodeScanner</code>]
///   </li>
///   <li>
...
///   </li>
/// </ul>
/// Note that the <code>FUIWelcomeScreen</code> is supported for iPad portrait and landscape orientation and iPhone portrait orientation only.
...
@interface FUIWelcomeScreen : FUIWelcomeController <UIScrollViewDelegate, UITextFieldDelegate>
/// :nodoc:
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
...
@interface UILabel (SWIFT_EXTENSION(SAPFiori))
@property (nonatomic) IBInspectable NSInteger firstLineFillPercent;
@property (nonatomic) IBInspectable NSInteger restLinesFillPercent;
